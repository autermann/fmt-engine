...
public class Activity extends Viewable<Activity> {
	...
	@NotBlank
	@SafeHtml
	@Property(ModelConstants.Activity.DESCRIPTION)
	private String description;
	@Indexed
	@NotNull
	@Reference(value = ModelConstants.Activity.FLASHMOB, lazy = true)
	...
	@Reference(value = ModelConstants.Activity.SIGNAL, lazy = true)
	private Signal signal;
	@Transient
	private Map<Role, Task> tasks = Utils.map();
	@NotBlank
	@SafeHtml
	@Property(ModelConstants.Activity.TITLE)
	private String title;
	@Reference(value = ModelConstants.Activity.TRIGGER, lazy = true)
	 ...
	 * 
	 * @param role
	 *            the role whose task shall be removed
	 * @return this activity
	 */
