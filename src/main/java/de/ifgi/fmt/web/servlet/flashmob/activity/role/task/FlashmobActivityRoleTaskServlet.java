package de.ifgi.fmt.web.servlet.flashmob.activity.role.task;
...
public class FlashmobActivityRoleTaskServlet extends AbstractServlet {
    /*
	...
	URI uri = getUriInfo().getBaseUriBuilder().path(Paths.TASKS_OF_ROLE_OF_ACTIVITY_OF_FLASHMOB).build(t.getId());
